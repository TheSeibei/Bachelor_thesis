...
\newcommand{\authorname}{Sebastian Bolek} % The author name without titles.
\newcommand{\thesistitle}{Towards Realistic Ultrasound Phantoms of the Mitral Valve} % The title of the thesis. The English version should be used, if it exists.
...
\setadvisor{Associate Prof. Dr.in}{Renata Georgia Raidou}{}{female}

% For bachelor and master theses:
\setfirstassistant{Dr. techn.}{Alexey Karimov}{}{male}
...
% Required data.
\setregnumber{12323843}
\setdate{01}{01}{2001} % Set date with 3 arguments: {day}{month}{year}.
\settitle{\thesistitle}{Towards Realistic Ultrasound Phantoms of the Mitral Valve} % Sets English and German version of the title (both can be English or German). If your title contains commas, enclose it with additional curvy brackets (i.e., {{your title}}) or define it as a macro as done with \thesistitle.
\setsubtitle{Thickness Reconstruction and Manufacturing of Leaflet Structures from Volumetric Ultrasound Data}{Thickness Reconstruction and Manufacturing of Leaflet Structures from Volumetric Ultrasound Data} % Sets English and German version of the subtitle (both can be English or German).
...
\setcurriculum{Informatics with specialization in Digital Health}{Informatik mit Vertiefung Digital Health} % Sets the English and German name of the curriculum.
...
% Add a bibliography.
\bibliographystyle{alpha} %ask: maybe change to {plain}
