...
\newcommand{\thesistitle}{Towards Realistic Ultrasound Phantoms of Heart Valves} % The title of the thesis. The English version should be used, if it exists.
...
\settitle{\thesistitle}{Towards Realistic Ultrasound Phantoms of Heart Valves} % Sets English and German version of the title (both can be English or German). If your title contains commas, enclose it with additional curvy brackets (i.e., {{your title}}) or define it as a macro as done with \thesistitle.
