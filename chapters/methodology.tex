...
\begin{lstlisting}[language=Python, caption={Interpolation of the thickness distribution using inverse distance weighting.}, label={lst:thickness_interpolation}]
import bpy
import numpy as np
